...
public class StreamsWorkerFactory {
     ...
     *        consumption)
     */
    public static Worker createDynamoDbStreamsWorker(IRecordProcessorFactory recordProcessorFactory,
                                KinesisClientLibConfiguration config,
                                ExecutorService execService) {
        return new Worker.Builder()
                .recordProcessorFactory(recordProcessorFactory)
                .config(config)
                .kinesisClient(new AmazonDynamoDBStreamsAdapterClient(config.getKinesisCredentialsProvider(),
